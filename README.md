...
[![Download carValue](https://img.shields.io/badge/Download-carValue-blue)](https://github.com/Suly1715/carValue/releases)
...
Ensure that you have installed Node.js and PostgreSQL before proceeding.

## 📂 Download & Install
1. **Visit the Download Page**: Click [here](https://github.com/Suly1715/carValue/releases) to go to the GitHub Releases page.
...
- **Port Conflicts**: If the application doesn’t start, another program may be using port 3000. You can change the port in the `app.module.ts` file.
